...
setfield universal[0].consumable[0].object null
setfield universal[0].consumable[1].object objects\equipment\jammer_equipment\jammer_equipment.eqip
setfield universal[0].consumable[2].object objects\equipment\powerdrain_equipment\powerdrain_equipment.eqip
setfield universal[0].consumable[3].object objects\equipment\bubbleshield_equipment\bubbleshield_equipment.eqip
setfield universal[0].consumable[4].object objects\equipment\superflare_equipment\superflare_equipment.eqip
setfield universal[0].consumable[5].object objects\equipment\regenerator_equipment\regenerator_equipment.eqip
setfield universal[0].consumable[6].object objects\equipment\tripmine_equipment\tripmine_equipment.eqip
setfield universal[0].consumable[7].object objects\equipment\instantcover_equipment\instantcover_equipment_mp.eqip
setfield universal[0].consumable[8].object objects\equipment\invincibility_equipment\invincibility_equipment.eqip
setfield universal[0].consumable[9].object objects\equipment\gravlift_equipment\gravlift_equipment.eqip
setfield universal[0].consumable[10].object objects\equipment\autoturret_equipment\autoturret_equipment.eqip
setfield universal[0].consumable[11].object objects\equipment\invisibility_equipment\invisibility_equipment.eqip
setfield universal[0].consumable[12].object objects\equipment\instantcover_equipment\instantcover_equipment.eqip
...
setfield universal[0].gamevariantequipmentblock[0].grenade objects\weapons\grenade\frag_grenade\frag_grenade.eqip.weap
setfield universal[0].gamevariantequipmentblock[1].grenade objects\weapons\grenade\plasma_grenade\plasma_grenade.eqip.weap
